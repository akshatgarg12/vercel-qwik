...
import type { StaticGenerateRenderOptions } from '@builder.io/qwik-city-new/static'
...
export declare interface VercelEdgeAdapterOptions extends ServerAdapterOptions {
    ...
    /**
     * Specify which enviornment the app needs to be deployed
     */
    vcConfigType: 'edge' | 'serverless'
}
